...
def restaurant_home():
    ...
    return render_template('restaurant_home.html',res_name=res_name,order_data=order_data,menu_data=menu_data, address = 'blank_address', phone_number = res_data['phone_number'], email_id = res_data['email_id'], start = res_data['start_time'], end = res_data['end_time'])
